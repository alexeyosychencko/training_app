...
SECRET_KEY = 'django-insecure-)u^&(@%5w3l4+4g+*(b65me6v$l*-9*9-o$@6l@x_zy5+wi3(#'
...
LOGIN_URL = 'training_app:login'
LOGIN_REDIRECT_URL = 'training_app:cadet_dashboard'
LOGOUT_REDIRECT_URL = 'training_app:login'
